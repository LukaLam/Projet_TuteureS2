...
public class BoutiqueRunner extends Application {
    ...
    public void start(Stage fenBoutiqueTot){
        ...
        butDecor.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                ouvrirBoutiqueDecors();
            }
        });

        Button butSkins = new Button("Apparence");
        butSkins.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                System.out.println("Boutique d'apparence");
            }
        });

        Button butMusique = new Button("Musiques");
        butMusique.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                System.out.println("Boutique de musiques");
            }
        });
    ...
    public void ouvrirBoutiqueDecors(){
        ...
        for (Decors elementDecors:listeDecors) {
            ...
            butAcheter.setOnAction(new EventHandler<ActionEvent>() {
                @Override
                public void handle(ActionEvent actionEvent) {
    ...
    public static void main(String[] args){
        Application.launch(BoutiqueRunner.class, args);
    }
}
